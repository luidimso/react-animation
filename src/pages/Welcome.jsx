...
export default function WelcomePage() {
  ...
  const opacityCityImage = useTransform(scrollY, [0, 200, 300, 500], [1, 0.5, 0.4, 0.2]);
  const yPOsitionCityImage =  useTransform(scrollY, [0, 200, 300, 500], [0, -100, -150, -200]);
  ...
  return (
    <>
      <header id="welcome-header">
        ...
        <motion.img
          style={{
            opacity: opacityCityImage,
            y: yPOsitionCityImage
          }}
          src={cityImg}
